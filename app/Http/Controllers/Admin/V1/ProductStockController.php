...
{
    protected $BaseModels = 'App\Models\ProductStock';
            ...
            if(!empty($RData['data'])){
                foreach($RData['data'] as &$v){
                    ...
                    if(!empty($code) && $code != NULL){
                        ...
                        $series_name = DB::table('pms_product_series')->where('id','=',$code)->pluck('name');
                        if(!empty($series_name) && $series_name != NULL) $v['series_name'] = $series_name;
                    }
                    // if(!empty($v['album_pics_wear'])) $v['album_pics_wear'] = cdnurl($v['album_pics_wear']);
                    // if(!empty($v['album_pics_exhibition'])) $v['album_pics_exhibition'] = cdnurl($v['album_pics_exhibition']);
                    // if(!empty($v['album_pics'])){
                    //     $album_pics = explode(',',$v['album_pics']);
                    //     foreach($album_pics as &$album_pics_v){
                    //         $album_pics_v =  cdnurl($album_pics_v);
                    //     }
                    //     $v['album_pics'] = $album_pics;
                    // }
                }
            }
        }
